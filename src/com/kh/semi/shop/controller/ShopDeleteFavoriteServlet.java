...
/**
 * Servlet implementation class ShopDeleteFavoriteServlet
 */
@WebServlet("/shopDeleteFavorite.si")
public class ShopDeleteFavoriteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShopDeleteFavoriteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = ss.shopFavoriteDelete(userId, shopPid);
